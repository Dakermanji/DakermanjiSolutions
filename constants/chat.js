...
export const CHAT_MESSAGE_RATE_LIMITS = Object.freeze({
	PUBLIC_ROOM_WINDOW_MS: 10 * 1000,
	PUBLIC_ROOM_MAX_MESSAGES: 5,
	NEW_PUBLIC_ROOM_MEMBER_AGE_MS: 10 * 60 * 1000,
	NEW_PUBLIC_ROOM_MEMBER_WINDOW_MS: 30 * 1000,
	NEW_PUBLIC_ROOM_MEMBER_MAX_MESSAGES: 5,
	BUCKET_TTL_MS: 30 * 60 * 1000,
});
